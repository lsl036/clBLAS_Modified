...
#ifndef KERNEL_DGEMM_COL_TT_B0_MX048_NL048_KX08_SRC_H
#define KERNEL_DGEMM_COL_TT_B0_MX048_NL048_KX08_SRC_H

const unsigned int dgemm_Col_TT_B0_MX048_NL048_KX08_workGroupNumRows = 8;
const unsigned int dgemm_Col_TT_B0_MX048_NL048_KX08_workGroupNumCols = 8;
const unsigned int dgemm_Col_TT_B0_MX048_NL048_KX08_microTileNumRows = 6;
const unsigned int dgemm_Col_TT_B0_MX048_NL048_KX08_microTileNumCols = 6;
const unsigned int dgemm_Col_TT_B0_MX048_NL048_KX08_unroll = 8;

const char * const dgemm_Col_TT_B0_MX048_NL048_KX08_src ="\n"
"/* dgemm_Col_TT_B0_MX048_NL048_KX08 */\n"
"\n"
...
"__kernel void dgemm_Col_TT_B0_MX048_NL048_KX08(\n"
...
"    lA[ 3*localAStride ] = A[ GET_GLOBAL_INDEX_A( globalARow(3), globalACol(3) ) ];\n"
"    lA[ 4*localAStride ] = A[ GET_GLOBAL_INDEX_A( globalARow(4), globalACol(4) ) ];\n"
"    lA[ 5*localAStride ] = A[ GET_GLOBAL_INDEX_A( globalARow(5), globalACol(5) ) ];\n"

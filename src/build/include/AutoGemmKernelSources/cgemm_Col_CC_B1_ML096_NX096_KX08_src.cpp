...
#ifndef KERNEL_CGEMM_COL_CC_B1_ML096_NX096_KX08_SRC_H
#define KERNEL_CGEMM_COL_CC_B1_ML096_NX096_KX08_SRC_H

const unsigned int cgemm_Col_CC_B1_ML096_NX096_KX08_workGroupNumRows = 16;
const unsigned int cgemm_Col_CC_B1_ML096_NX096_KX08_workGroupNumCols = 16;
const unsigned int cgemm_Col_CC_B1_ML096_NX096_KX08_microTileNumRows = 6;
const unsigned int cgemm_Col_CC_B1_ML096_NX096_KX08_microTileNumCols = 6;
const unsigned int cgemm_Col_CC_B1_ML096_NX096_KX08_unroll = 8;

const char * const cgemm_Col_CC_B1_ML096_NX096_KX08_src ="\n"
"/* cgemm_Col_CC_B1_ML096_NX096_KX08 */\n"
"\n"
"/* kernel parameters */\n"
...
"__kernel void cgemm_Col_CC_B1_ML096_NX096_KX08(\n"
...
"    lA[ 1*localAStride ] = ( globalARow(1) >= M) ? (float2)(0.f, 0.f) : A[ GET_GLOBAL_INDEX_A( globalARow(1), globalACol(1) ) ];\n"
"    lA[ 2*localAStride ] = ( globalARow(2) >= M) ? (float2)(0.f, 0.f) : A[ GET_GLOBAL_INDEX_A( globalARow(2), globalACol(2) ) ];\n"

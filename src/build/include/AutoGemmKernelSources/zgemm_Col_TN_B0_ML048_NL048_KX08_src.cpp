...
#ifndef KERNEL_ZGEMM_COL_TN_B0_ML048_NL048_KX08_SRC_H
#define KERNEL_ZGEMM_COL_TN_B0_ML048_NL048_KX08_SRC_H

const unsigned int zgemm_Col_TN_B0_ML048_NL048_KX08_workGroupNumRows = 16;
const unsigned int zgemm_Col_TN_B0_ML048_NL048_KX08_workGroupNumCols = 16;
const unsigned int zgemm_Col_TN_B0_ML048_NL048_KX08_microTileNumRows = 3;
const unsigned int zgemm_Col_TN_B0_ML048_NL048_KX08_microTileNumCols = 3;
const unsigned int zgemm_Col_TN_B0_ML048_NL048_KX08_unroll = 8;

const char * const zgemm_Col_TN_B0_ML048_NL048_KX08_src ="\n"
"/* zgemm_Col_TN_B0_ML048_NL048_KX08 */\n"
"\n"
...
"__kernel void zgemm_Col_TN_B0_ML048_NL048_KX08(\n"
...
"    if ( localSerial + 1*WG_NUM_ROWS*WG_NUM_COLS < (WG_NUM_ROWS*MICRO_TILE_NUM_ROWS*NUM_UNROLL_ITER) ) {\n"
"      lA[ 1*localAStride ] = ( globalARow(1) >= M) ? (double2)(0.0, 0.0) : A[ GET_GLOBAL_INDEX_A( globalARow(1), globalACol(1) ) ];\n"
"    }\n"
"    lB[ 0*localBStride ] = ( globalBCol(0) >= N) ? (double2)(0.0, 0.0) : B[ GET_GLOBAL_INDEX_B( globalBRow(0), globalBCol(0) ) ];\n"
"    if ( localSerial + 1*WG_NUM_ROWS*WG_NUM_COLS < (WG_NUM_COLS*MICRO_TILE_NUM_COLS*NUM_UNROLL_ITER) ) {\n"
"      lB[ 1*localBStride ] = (globalBCol(1) >= N) ? (double2)(0.0, 0.0) : B[ GET_GLOBAL_INDEX_B( globalBRow(1), globalBCol(1) ) ];\n"
"    }\n"
"    barrier(CLK_LOCAL_MEM_FENCE);\n"
"    uint offA = localRow;\n"
"    uint offB = localCol;\n"

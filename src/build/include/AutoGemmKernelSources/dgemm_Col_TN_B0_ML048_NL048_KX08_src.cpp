...
#ifndef KERNEL_DGEMM_COL_TN_B0_ML048_NL048_KX08_SRC_H
#define KERNEL_DGEMM_COL_TN_B0_ML048_NL048_KX08_SRC_H

const unsigned int dgemm_Col_TN_B0_ML048_NL048_KX08_workGroupNumRows = 8;
const unsigned int dgemm_Col_TN_B0_ML048_NL048_KX08_workGroupNumCols = 8;
const unsigned int dgemm_Col_TN_B0_ML048_NL048_KX08_microTileNumRows = 6;
const unsigned int dgemm_Col_TN_B0_ML048_NL048_KX08_microTileNumCols = 6;
const unsigned int dgemm_Col_TN_B0_ML048_NL048_KX08_unroll = 8;

const char * const dgemm_Col_TN_B0_ML048_NL048_KX08_src ="\n"
"/* dgemm_Col_TN_B0_ML048_NL048_KX08 */\n"
"\n"
...
"__kernel void dgemm_Col_TN_B0_ML048_NL048_KX08(\n"
...
"    lB[ 3*localBStride ] = ( globalBCol(3) >= N) ? 0.0 : B[ GET_GLOBAL_INDEX_B( globalBRow(3), globalBCol(3) ) ];\n"
"    lB[ 4*localBStride ] = ( globalBCol(4) >= N) ? 0.0 : B[ GET_GLOBAL_INDEX_B( globalBRow(4), globalBCol(4) ) ];\n"
"    lB[ 5*localBStride ] = ( globalBCol(5) >= N) ? 0.0 : B[ GET_GLOBAL_INDEX_B( globalBRow(5), globalBCol(5) ) ];\n"
"    barrier(CLK_LOCAL_MEM_FENCE);\n"
"    uint offA = localRow;\n"
"    uint offB = localCol;\n"
"\n"

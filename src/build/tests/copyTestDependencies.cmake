...
#    message( testLocation ": /home/lsl/clBLAS-2.12/src/build/staging/test-correctness" )
...
if( "${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "Debug" )
    string( REPLACE "\$(Configuration)" "Debug" fixedTestLocation "/home/lsl/clBLAS-2.12/src/build/staging/test-correctness" )
elseif( "${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "Release" )
    string( REPLACE "\$(Configuration)" "Release" fixedTestLocation "/home/lsl/clBLAS-2.12/src/build/staging/test-correctness" )
elseif( "${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "MinSizeRel" )
    string( REPLACE "\$(Configuration)" "MinSizeRel" fixedTestLocation "/home/lsl/clBLAS-2.12/src/build/staging/test-correctness" )
elseif( "${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "RelwithDebInfo" )
    string( REPLACE "\$(Configuration)" "RelwithDebInfo" fixedTestLocation "/home/lsl/clBLAS-2.12/src/build/staging/test-correctness" )
endif( )
...
if( WIN32 )
    ...
    set( installPath "${CMAKE_INSTALL_PREFIX}/lib64" )
endif( )
...
get_filename_component( openclDir "/usr/lib/x86_64-linux-gnu/mwv207/libOpenCL.so" PATH )
